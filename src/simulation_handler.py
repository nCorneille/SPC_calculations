...
class SimulationHandler:
    ...
    def simulate_run_length(self, changepoint: int = -1, changepoint_distribution=lambda x: x,
        ...
        return self.simulate_run_length_variable_rules(self.stopping_rules, changepoint, changepoint_distribution,
                                                       max_iterations, LCL)

    def simulate_inspection_length(self, changepoint: int = -1, changepoint_distribution = lambda x: x,
                            max_iterations: int = 10000, LCL=0):
        """
        ...
        """
        return self.simulate_inspection_length_variable_rules(self.stopping_rules, changepoint,
                                                              changepoint_distribution, max_iterations, LCL)

    def simulate_run_length_variable_rules(self, stopping_rules, changepoint: int = -1,
                                           changepoint_distribution=lambda x: x,
                                           max_iterations: int = 1000, LCL=0):
        """
        Samples max_iterations points from sampling_distribution and returns
        the minimum index for which an OC signal is given.
    ...
    def simulate_inspection_length_variable_rules(self, stopping_rules, changepoint: int = -1,
                                           changepoint_distribution=lambda x: x,
                                           max_iterations: int = 1000, LCL=0):
        """
        Samples max_iterations points from sampling_distribution and returns
        ...
        return np.sum(data[0::np.min(n) + 1])
